        ...
        <div className="drawer xl:drawer-open">
            ...
            <div className="drawer-content">
                <label 
                    ...
                    className="btn btn-primary btn-md drawer-button xl:hidden fixed top-37 right-4 z-50"
                >
                    Toggle drawer
                </label>
                {children}
            ...
            <div className="drawer-side">
                ...
                <ul className="menu bg-base-200 text-base-content min-h-full w-80 p-4 z-50 relative">
